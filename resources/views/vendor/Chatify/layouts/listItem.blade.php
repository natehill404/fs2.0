            ...
            <td style="position: relative">
                ...
                @endif
                    ...
                    @elseif($user->gender === "male")
                        <div class="avatar av-m"
                             style="background-image: url('{{asset('img/profile/male.png')}}');"></div>
                    @elseif($user->gender === "female")
                        <div class="avatar av-m"
                             style="background-image: url('{{asset('img/profile/female.png')}}');"></div>
                    @else
                        <div class="avatar av-m"
                             style="background-image: url('{{asset('img/profile/default.png')}}');"></div>
                    @endif
            </td>
            {{-- center side --}}
            <td>
